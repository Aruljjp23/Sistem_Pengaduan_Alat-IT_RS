...
<div class="row">
   <div class="col-xl-3 col-md-6">
        <div class="card mb-4 shadow-sm" style="border: none; border-radius: 12px; background: linear-gradient(135deg, #23daff, #23daff);">
            @php
                $perangkat = DB::table('perangkat')->get();
            @endphp
            <div class="card-body d-flex align-items-center justify-content-between px-4 py-3">
                <div>
                    <div style="font-size: 0.75rem; color: rgba(0, 0, 0, 0.75); text-transform: uppercase; letter-spacing: 1px; font-weight: 600;">Total Perangkat</div>
                ...
                <div style="background: rgba(255,255,255,0.15); border-radius: 50%; width: 55px; height: 55px; display: flex; align-items: center; justify-content: center;">
                    <i class="fas fa-desktop" style="font-size: 1.5rem; color: #000000;"></i>
                </div>
            </div>
            <div class="card-footer d-flex align-items-center justify-content-between px-4 py-2" 
                ...
                <a href="{{ url('/perangkat/data_perangkat') }}" style="font-size: 0.8rem; color: rgba(0, 0, 0, 0.85); text-decoration: none;">
                    Lihat Detail
                </a>
    ...
    <div class="col-xl-12">
        <div class="card mb-4">
            <div class="card-header">
                ...
                Total Tindakan Per Bulan ({{ date('Y') }})
            </div>
            <div class="card-body">
...
<script>
    @php
        $tindakanPerBulan = DB::table('tindakan')
        ...
        for ($i = $bulanMulai; $i <= $bulanSekarang; $i++) {
            ...
            $found = $tindakanPerBulan->firstWhere('bulan', $i);
